    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/30 to-secondary/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
        <header className="mb-12 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-foreground via-primary to-accent bg-clip-text text-transparent  text-purple-800">
            Featured Projects
          </h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto text-slate-500">
